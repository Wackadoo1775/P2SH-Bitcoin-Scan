...
color = 'cyan'
cprint(figlet_format('WACKADOO'), color)



wackadoo = '''
=========================[W A C K A D O O 1 7 7 5]==============================
Author : WACKADOO1775

Follow me @ Github.Com/Wackadoo1775

Bitcoin Donations = bc1qgu2xhzytnsexaqlxt9ly7agtyg0gtrar6n8k27

=========================[W A C K A D O O 1 7 7 5]==============================
        '''

print(green, wackadoo)
time.sleep(5)
z = 1
# =========================[W A C K A D O O 1 7 7 5]==============================
...
while True:
    ...
    rnd = str(small)[:2]
    # =========================[W A C K A D O O 1 7 7 5]==============================
    print(red, str(z), 'ADDRESS =', str(btcaddr1), str(rnd), '[ WACKADOO ]')
    z += 1
    # =========================[W A C K A D O O 1 7 7 5]==============================
    if int(rnd) > 0:
        print('=======================[W A C K A D O O 1 7 7 5]=======================')
        print('Saved pivate key and total balance on Jackpot.txt ')
        print('=======================[W A C K A D O O 1 7 7 5]=======================')
        f = open("Jackpot.txt", "a")
        f.write(privatekey + '\n')
        f.write(btcaddr1 + '  BAL= ' + rnd + '\n')
        f.write('=======================[W A C K A D O O 1 7 7 5]=======================')
        f.write('Donate (BTC) = bc1qgu2xhzytnsexaqlxt9ly7agtyg0gtrar6n8k27')
        f.write('=======================[W A C K A D O O 1 7 7 5]=======================')
        f.close()
        # =========================[W A C K A D O O 1 7 7 5]==============================
        continue
